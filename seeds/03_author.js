exports.seed = function(knex, Promise) {
	return Promise.all([
		...
		knex('author').insert({
			first_name: 'Daniel',
			last_name: 'Abbott',
			bio: 'I\'m just really weird.',
			portrait_url: 'https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/12360376_10153685988635470_7411792991439000269_n.jpg?oh=9088dfd514e98ace7f95088e196b66e4&oe=57F71073'
		})
	]);
};
